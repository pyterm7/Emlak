    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('the_initial_payment', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1000000)], verbose_name='İlkin ödəniş')),
                ...
                ('floor', models.IntegerField(blank=True, null=True, verbose_name='Mərtəbə')),
                ('floor_count', models.IntegerField(blank=True, null=True, verbose_name='Mərtəbə sayı')),
                ('apartment', models.IntegerField(blank=True, null=True, verbose_name='Mənzil nömrəsi')),
