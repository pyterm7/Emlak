    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instagram', models.CharField(max_length=225, verbose_name='İnstagram')),
                ('youtube', models.CharField(max_length=225, verbose_name='YouTube')),
                ('twitter', models.CharField(max_length=225, verbose_name='Twitter')),
                ('tiktok', models.CharField(max_length=225, verbose_name='TikTok')),
                ('vimeo', models.CharField(max_length=225, verbose_name='Vimeo')),
                ('pinterest', models.CharField(max_length=225, verbose_name='Pinterest')),
